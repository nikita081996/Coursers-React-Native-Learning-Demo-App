...
import RatingComment from './RatingCommentComponents';
...
const RatingCommentNavigator = createStackNavigator(
  {
    Reservation: { screen: RatingComment }
  },
  {
    navigationOptions: ({ navigation }) => ({
      headerStyle: {
